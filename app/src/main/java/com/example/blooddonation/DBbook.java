...
public class DBbook extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table bookings(dononame varchar, id varchar, bloodtype varchar, donodate varchar)");
    }
    ...
    public boolean insert(String dononame, String id, String bloodtype, String donodate){
    ...
    public ArrayList<HashMap<String, String>> viewbookings(){
        ...
        Cursor c=db.rawQuery("SELECT dononame, id, donodate FROM bookings",null);
        while (c.moveToNext()){
